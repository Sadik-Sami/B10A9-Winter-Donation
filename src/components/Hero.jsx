	...
	return (
		<div className='relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:my-12 xl:max-w-6xl'>
			<div className='image-column w-full h-64 lg:w-1/2 lg:h-auto'>
				<img
					className='h-full lg:h-[500px] w-full object-top lg:object-cover lg:rounded-xl'
					src='https://dietmartemps.com/media_library/image/61842_1518872278188.jpg'
					alt='Winding mountain road in winter'
				/>
			</div>

			<div className='text-column max-w-lg bg-snow-50/80 md:max-w-2xl md:z-10 md:shadow-lg md:absolute md:top-0 md:mt-48 lg:w-3/5 lg:left-0 lg:mt-20 lg:ml-20 xl:mt-24 xl:ml-12'>
